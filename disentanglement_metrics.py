...
from metric_helpers.mi_metric import compute_metric_shapes, compute_metric_faces, compute_metric_3dshapes
...
def mutual_info_metric_3dshapes(vae, shapes_dataset):
    ...
    for i in range(8):
        ...
        cond_entropies[0] += cond_entropies_i.cpu() / 8
    ...
    for i in range(15):
        ...
        cond_entropies[0] += cond_entropies_i.cpu() / 15

    metric = compute_metric_3dshapes(marginal_entropies, cond_entropies)
    return metric, marginal_entropies, cond_entropies
...
def mutual_info_metric_mpi3D(vae, shapes_dataset):
    ...
    for i in range(40):
        ...
        cond_entropies[3] += cond_entropies_i.cpu() / 40
...
if __name__ == '__main__':
    ...
    print('mutual_info_metric_' + cpargs.dataset)
